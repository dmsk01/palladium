...
window.onload = function () {
  ...
  function workCases(e) {
    ...
    if (window.innerWidth < 991.98) {
      if (clickedElem.classList.contains("cases__type-name")) {
        clickedElem.closest(".cases__group").classList.toggle("_active");
      }

      if (
        clickedElem.closest(".cases__group") &&
        clickedElem.classList.contains("cases__title")
      ) {
        removeClasses(
          document.querySelectorAll(".cases__group._active"),
          "_active"
        );
      }
      ...
      if (
        !clickedElem.closest(".cases__group") &&
        document.querySelectorAll(".cases__group._active").length > 0
      ) {
        removeClasses(
          document.querySelectorAll(".cases__group._active"),
          "_active"
